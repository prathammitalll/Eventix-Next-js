...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    const endElementTop = endElement
      ? endElement.offsetTop + scroller.offsetTop
      : 0;
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      if (blurAmount) {
        ...
        for (let j = 0; j < cardsRef.current.length; j++) {
          const jCardTop = cardsRef.current[j].offsetTop + scroller.offsetTop;
          const jTriggerStart =
  ...
  const setupLenis = useCallback(() => {
    ...
    // Use main document scroll instead of creating isolated scroll
